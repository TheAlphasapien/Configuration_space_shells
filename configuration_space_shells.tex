...
Figure~\ref{fig:transmon_decoherence_fit.png} shows synthetic transmon decoherence data with measurement noise characteristic of state-of-the-art systems (5\% relative uncertainty). Linear fitting to $\Gamma = \nu|\Delta E| + \Gamma_0$ yields:
